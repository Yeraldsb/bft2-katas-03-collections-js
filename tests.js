...
describe("Operaciones iterables", () => {
    ...
    it("map nos permite realizar operaciones elemento a elemento (2)", () => {
        ...
        const result = list.splice(0, 3 , "Pikachu, te elijo a ti!", "Charmander, te elijo a ti!", "Magikarp, te elijo a ti!")
    ...
    it("filtrando planetas", () => {
       ...
       /* function endsWithC(str){
           return str.endsWith('c');
        }
*/
        let result = knownExoplanets.filter(str => str.endsWith('c')) ;
